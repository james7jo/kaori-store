...
*📍 DATOS DE ENTREGA:*
• *Dirección:* ${regionNombre || "No especificada"}
${ubicacion ? `• *Mapa Exacto:* ${ubicacion}` : "• *Ubicación:* Pendiente de coordinar"}

_Por favor, confirma si la dirección de arriba es correcta o envía tu ubicación actual._`;
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 gap-2 pt-4">
                        ...
                        <div className="flex justify-between items-center py-2 border-b border-gray-50">
                          ...
                          >
                            {producto.estado === "usado" ? "Usado" : "Nuevo"}
                          </span>
                        </div>
                      </div>
